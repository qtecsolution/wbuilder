(function () {
  ...
  TagsInput.prototype.init = function (opts) {
    ...
    this.input.placeholder = "Filter Value";
...
const addFilterValue = new TagsInput({
  selector: 'addfiltervalue',
  duplicate: false,
  max: 10
});
addFilterValue.addData([]);

const editFilterValue = new TagsInput({
  selector: 'editfiltervalue',
  duplicate: false,
  max: 10
});
editFilterValue.addData([]);